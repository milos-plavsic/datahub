...
SQLAlchemy is a data platform used to store and query analytical or operational data. Learn more in the [official SQLAlchemy documentation](https://www.sqlalchemy.org/).

The DataHub integration for SQLAlchemy covers core metadata entities such as datasets/tables/views, schema fields, and containers. It also captures table- and column-level lineage, data profiling, and stateful deletion detection.
