...
Presto is a data platform used to store and query analytical or operational data. Learn more in the [official Presto documentation](https://prestodb.io/).

The DataHub integration for Presto covers core metadata entities such as datasets/tables/views, schema fields, and containers. It also captures table- and column-level lineage, data profiling, and stateful deletion detection.
...
- [Hive Metastore Connector Documentation](https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/hive-metastore)

:::

#### Related Documentation

- [Presto Configuration Examples](https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/sources/presto_recipe.yml)
- [Hive Metastore Connector](https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/hive-metastore) - For Presto-on-Hive with storage lineage
- [Trino Connector](https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/trino) - Similar connector for Trino (Presto's successor)
...
**Solution**: Use the [Hive Metastore connector](https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/hive-metastore) with `mode: presto` to get storage lineage for Presto views backed by Hive.
...
- For Hive-backed views, consider using the [Hive Metastore connector](https://github.com/datahub-project/datahub/blob/master/docs/generated/ingestion/hive-metastore) with `mode: presto`
